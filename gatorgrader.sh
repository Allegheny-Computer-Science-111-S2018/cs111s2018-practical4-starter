...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour/ \
                                     --checkfiles DisplayComplementaryDrawingCanvas.java --singlecomments 4 --multicomments 2 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "new Date()" fragment exists in the code at least once
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
                                     --checkfiles DisplayComplementaryDrawingCanvas.java --fragments "new Date()" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK: the "CANVAS_HEIGHT" fragment exists in the code at least twice
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
                                     --checkfiles DisplayComplementaryDrawingCanvas.java --fragments "CANVAS_HEIGHT" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "CANVAS_WIDTH" fragment exists in the code at least twice
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
                                     --checkfiles DisplayComplementaryDrawingCanvas.java --fragments "CANVAS_WIDTH" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "redValue" fragment exists in the code at least twice
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
                                     --checkfiles DisplayComplementaryDrawingCanvas.java --fragments "redValue" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "greenValue" fragment exists in the code at least twice
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
                                     --checkfiles DisplayComplementaryDrawingCanvas.java --fragments "greenValue" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "blueValue" fragment exists in the code at least twice
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
                                     --checkfiles DisplayComplementaryDrawingCanvas.java --fragments "blueValue" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the correct number of comments in the Java code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour/ \
                                     --checkfiles PaintComplementaryDrawingCanvas.java --singlecomments 4 --multicomments 2 --language Java
  determine_exit_code $?
  # --> GatorGrader CHECK: the "CANVAS_HEIGHT" fragment exists in the code at least twice
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
                                     --checkfiles PaintComplementaryDrawingCanvas.java --fragments "CANVAS_HEIGHT" --fragmentcounts 2
  determine_exit_code $?
  # --> GatorGrader CHECK: the "CANVAS_WIDTH" fragment exists in the code at least twice
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfour \
                                     --checkfiles PaintComplementaryDrawingCanvas.java --fragments "RGB_MAXIMUM" --fragmentcounts 2
  determine_exit_code $?
  echo ""
